public class Empleados {
    ...
    public Empleados(int id, String nombre, String apellido, String tipo_doc, String nro_doc, String nro_tel_princ, String nro_tel_sec, String email, int id_departamento) {
        this.id = id;
        this.nombre = nombre;
